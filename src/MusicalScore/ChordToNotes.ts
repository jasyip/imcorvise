...
export class ChordToNotes
{
    ...
    private static getInts(chord: ChordSymbolContainer): number[]
    {
        switch (chord.ChordKind)
        {
            ...
            case ChordSymbolEnum.majorsixth: return [0, 0, 4, 0, 7, 0, 9];
            case ChordSymbolEnum.minorsixth: return [0, 0, 3, 0, 7, 0, 9];
            ...
            case ChordSymbolEnum.Neapolitan: return [0, 0, 4, 0, 0, 8];
            case ChordSymbolEnum.Italian: return [0, ];
            case ChordSymbolEnum.French: return [0, ];
            case ChordSymbolEnum.German: return [0,];
